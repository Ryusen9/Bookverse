...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full flex items-center justify-between p-2 bg-black">
      <div className="flex relative items-center z-50 justify-between py-2 px-5 border bg-black dark:bg-white text-white dark:text-black mx-auto w-full md:w-3/5 rounded-2xl">
        <div onClick={toggleMobileMenuFunctions} className="lg:hidden text-2xl z-30">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <div>
            <button
              ...
              className="text-xl cursor-pointer z-30 text-white dark:text-white bg-white dark:bg-black p-1.5 rounded-full relative"
            >
              <PiMagnifyingGlassLight />
            </button>
          </div>
          {/* Cart */}
          <div className="text-xl z-30 text-white dark:text-white bg-white dark:bg-black p-1.5 rounded-full relative">
            <PiShoppingCart />
